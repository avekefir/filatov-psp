...
const stocksRouter = require('./software_routes/software_stocks');
const stocksService = require('./software_services/software_stocksService');
...
app.use('/software_stocks', stocksRouter);
